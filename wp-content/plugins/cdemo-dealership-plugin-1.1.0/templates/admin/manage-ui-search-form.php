<?php
/**
 * Template for managing the search from fields UI.
 *
 * @since 1.0.0
 * @package cdemo
 * @subpackage admin
...
<div class="cdemo-manage-ui">
    ...
    <form action="?">
        ...
        <label for="ui-category"><?php _e( 'Select a context to edit:', 'cdemo' ); ?></label>

        <select name="context" id="ui-category">

            <option value="global" <?php selected( 'global', $context ); ?> >
                <?php _e( 'Global Inventory', 'cdemo' ); ?>
            </option>
                    ...
                    <ul id="cdemo-available-fields" class="ui-fields">
                        ...
                        <?php foreach ( $fields as $id => $field ) : ?>
                            ...
                            <?php if ( empty( $config ) || !array_key_exists( $id, $config ) ) : ?>
                                ...
                                <li class="ui-field">
                                    <?php render_ui_edit_form_field( $option, $context, $id, $field['title'], $field['edit_callback'], $field['defaults'] ); ?>
                                </li>
                        ...
                        <div class="inner wp-clearfix">
                            ...
                            <ul id="cdemo-fields-configuration" class="ui-fields">
                                ...
                                <?php if ( !empty( $config ) ) : ?>
                                    ...
                                    <?php foreach ( $config as $id => $field ) : ?>

                                        <?php if ( array_key_exists( $id, $fields ) ) : ?>

                                            <li class="ui-field editable">
                                                <?php render_ui_edit_form_field( $option, $context, $id, $fields[ $id ]['title'], $fields[ $id ]['edit_callback'], $field ); ?>
                                            </li>
