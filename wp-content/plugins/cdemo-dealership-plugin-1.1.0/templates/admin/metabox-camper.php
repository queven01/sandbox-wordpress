<?php
/**
 * Template for the camper matabox.
 *
 * @since 1.1.0
 * @package cdemo
 */
    ...
    <div id="details" class="metabox-section">
        ...
        <div class="metabox-group capacity">
            ...
            <div class="form-field">
                ...
                <label class="label" for="cdemo-sleeping-capacity">
                    <?php _e( 'Sleeping Capacity', 'cdemo' ); ?>
                </label>

                <div class="input-group">

                    <div class="input-group-addon">
                        <?php meta_field_lock( 'sleeping_capacity' );  ?>
                    </div>

                    <input id="cdemo-sleeping-capacity"
                           name="sleeping_capacity"
                           class="meta-field"
                           type="text"
                           value="<?php esc_attr_e( get_metadata( 'sleeping_capacity' ) ); ?>" />
        ...
        <div class="metabox-group body">
            ...
            <div class="form-field">
                ...
                <label class="label" for="cdemo-pushout-count">
                    <?php _e( 'Push-Outs', 'cdemo' ); ?>
                </label>

                <div class="input-group">

                    <div class="input-group-addon">
                        <?php meta_field_lock( 'pushout_count' ); ?>
                    </div>
                    ...
                    <input id="cdemo-axle-count"
                           ...
                           data-field-depend="#post_type"
                           type="text"
                           value="<?php esc_attr_e( get_metadata( 'pushout_count' ) ); ?>" />
